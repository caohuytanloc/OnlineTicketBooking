...
public class Flight {
   ...
   List<SeatType>list;
    public Flight(String id, String airplaneName, String departureTime, String arrivalCity, String departureCity, String arrivalTime, int availableSeats, int totalSeats){}
