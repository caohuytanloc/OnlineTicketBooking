...
<jsp:useBean id="list" class="com.onlineticketbookingwebsite.entity.FlightsEntity" scope="request"></jsp:useBean>
...
<%--                </a>--%>
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
              <c:forEach var="o" items="${list.getLights()}">
               <tr>
                    <td>${o.id}</td>
                    <td>${o.airplaneName}</td>
                    <td>${o.departureCity}</td>
                    <td>${o.arrivalCity}</td>
                    <td>${o.departureTime}</td>
                    <td>${o.arrivalTime}</td>
  <td><div class="col-sm-2">
    <a class="btn btn-excel btn-sm" href="" title="In"><i class="fas fa">${o.availableSeats}/${o.totalSeats} </i></a>
  </div></td>
  <td class="table-td-center">
    <a class="btn btn-add btn-sm" href="addTicket.jsp" title="Đặt vé">
      Đặt vé</a>
<%--    <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"--%>
<%--                                      onclick="myFunction(this)"><i class="fas fa-trash-alt"></i>--%>
<%--  </button>--%>
<%--    <button class="btn btn-add btn-sm plus" type="button" title="Thêm vé" id="show-emd" data-toggle="modal" data-target="#ModalUP">Thêm vé<i class="fas fa-plus"></i>--%>
<%--    </button>--%>
  </td>
</tr>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="form-group  col-md-6">
              ...
              <input id= "departure_city" name="departure_city"  class="form-control" type="text" required value="">
            </div>
            <div class="form-group col-md-6">
              <label class="control-label">Điểm đến</label>
              <input id="arrival_city" name="arrival_city" class="form-control" type="text" required value="">
            </div>
            <div class="form-group col-md-6">
