  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Đặt vé mới</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <div class="tile-body">
            <form class="row">
              ...
              <div class="form-group  col-md-3">
                <label for="exampleSelect1" class="control-label">Loại ghế</label>
              ...
              <div class="form-group col-md-3">
                <label class="control-label">Mã số ghế</label>
                <select class="form-control" id="exampleSelect3">
                  <option>-- Chọn mã số ghế --</option>
          ...
          <button class="btn btn-save" type="button">Đặt vé</button>
          <a class="btn btn-cancel" href="/ticketManagement">Hủy bỏ</a>
        </div>
