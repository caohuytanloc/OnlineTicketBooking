    ...
    <div class="container">
        <div class="row ">
                ...
                <div class="container">
                    ...
                    <c:forEach var="flight" items="${sessionScope.listfightreturn}">
                        ...
                        <div class="row">
                            ...
                            <div class="col" id="type1" onclick="change(this)">
                                <p>${flight.getPriceSeatFirst()}</p>
                            </div>

                            <div class="col" id="type2" onclick="change(this)">
                                <p>${flight.getPriceSeatBusiness()}</p>
                            </div>
                            <div class="col" id="type3" onclick="change(this)">
                                <p>${flight.getPriceSeatPremium()}</p>
                            </div>
                            <div class="col" id="type4" onclick="change(this)">
            ...
            <div class="container_right col-md-4">
                ...
                <jsp:include page="/ticketbooking/frame2.jsp"/>
...
<script>
    ...
    //     totalElement.innerText = (pricegoElement + pricreutrnnew).toLocaleString("vi-VN") + " VND";
    // }
    function change(clicked) {
        var priceticketElement = document.getElementById("priceticketreturn");
        var taxElement = document.getElementById("taxreturn");
