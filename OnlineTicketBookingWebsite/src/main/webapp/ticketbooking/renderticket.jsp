        ...
        <div class="lable-heder">
            <div class="labelgo">
                <div class="lablego1">
                    ...
                    <label for=""><i class="fa-solid fa-circle"></i>Điểm Khời hành</label>
                    <label for="" style="color:red;font-weight: bold; ">TP.HỒ CHÍ MINH</label>
                </div>
                <div class="lablego2">

                    <label for=""> <i class="fa-solid fa-location-dot" style="color: rgb(37, 186, 47);"></i>
                        Điểm Đến</label>
                    <label for="" style="color:red;font-weight: bold; "> HÀ NỘI</label>
                </div>
                <div class="lablego3">
    ...
    <div class="row ">
        ...
        <div class="left-container col-8">
            ...
            <div class="date-flight">
                ...
                <div style="background: linear-gradient(28.91deg, #F9A51A 2.24%, #FBB612 31.03%, #FBF300 97.21%);"
                     class="cloud">
                    <label for="" class="clound-lable1">Chủ nhật</label>
                    <label for="" class="clound-lable2"> ngày 14 tháng 5</label>
                    <label for="" class="clound-lable2">Giá vé chỉ từ 199.000 VND</label>
                </div>
                <div>
                    <label for="">Chủ nhật</label>
                    <label for=""> ngày 14 tháng 5</label>
                    <label for="">Giá vé chỉ từ 199.000 VND</label>
                </div>
                <div>
                    <label for="">Chủ nhật</label>
                    <label for=""> ngày 14 tháng 5</label>
        ...
        <div class="container-right col-4">
            <div class="infor">
                ...
                <div>
                    <button class="buttondetail">Chi tiết</button>
                </div>
            </div>
